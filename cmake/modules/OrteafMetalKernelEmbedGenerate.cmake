...
string(APPEND content "namespace mps = orteaf::internal::backend::mps;\n\n")
...
string(APPEND content "MetallibBlob findLibraryData(std::string_view library_name) {\n")
...
string(APPEND content "    MetallibBlob blob = findLibraryData(library_name);\n")
...
string(APPEND content "        if (error) { *error = mps::createError(\"orteaf.mps.kernel\", \"Invalid MPS device\"); }\n")
string(APPEND content "        return nil;\n")
string(APPEND content "    }\n")
string(APPEND content "    MetallibBlob blob = findLibraryData(library_name);\n")
string(APPEND content "    if (blob.data == nullptr || blob.size == 0) {\n")
string(APPEND content "        if (error) { *error = mps::createError(\"orteaf.mps.kernel\", \"Embedded metallib not found\"); }\n")
string(APPEND content "        return nil;\n")
string(APPEND content "    }\n")
string(APPEND content "    MPSError_t local_error = nullptr;\n")
string(APPEND content "    MPSLibrary_t library = mps::createLibraryWithData(device, blob.data, blob.size, &local_error);\n")
string(APPEND content "    if (library == nil) {\n")
string(APPEND content "        if (error) { *error = local_error; } else if (local_error) { mps::destroyError(local_error); }\n")
string(APPEND content "        return nil;\n")
string(APPEND content "    }\n")
string(APPEND content "    if (local_error) { mps::destroyError(local_error); }\n")
string(APPEND content "    MPSFunction_t function = create_function(library, function_name);\n")
string(APPEND content "    if (function == nil) {\n")
string(APPEND content "        mps::destroyLibrary(library);\n")
string(APPEND content "        if (error) { *error = mps::createError(\"orteaf.mps.kernel\", \"Failed to create MTLFunction\"); }\n")
string(APPEND content "        return nil;\n")
string(APPEND content "    }\n")
string(APPEND content "    mps::destroyLibrary(library);\n")
