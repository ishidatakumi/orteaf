...
string(APPEND content "#include \"orteaf/internal/backend/cuda/cuda_kernel_embed_api.h\"\n")
...
foreach(record ${record_list})
    ...
    list(APPEND entry_list "Entry{\"${kernel_raw}\", ${fmt_enum}, ${prefix}_start, ${prefix}_end}")
endforeach()

string(APPEND content "${declarations}\n")
string(APPEND content "namespace orteaf::internal::backend::cuda::kernel_embed {\n\n")
string(APPEND content "namespace {\n")
string(APPEND content "struct Entry {\n")
string(APPEND content "    const char* name;\n")
string(APPEND content "    CudaKernelFmt fmt;\n")
...
string(APPEND content "static Blob make_blob(const Entry& entry) {\n")
...
string(APPEND content "        }\n")
string(APPEND content "    }\n")
string(APPEND content "    return fallback;\n")
string(APPEND content "}\n\n")

string(APPEND content "bool available(std::string_view name, CudaKernelFmt fmt) {\n")
string(APPEND content "    if (name.empty()) {\n")
string(APPEND content "        using namespace orteaf::internal::diagnostics::error;\n")
