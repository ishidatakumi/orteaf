...
namespace orteaf::internal::runtime::backend_ops::cpu {

/**
 * @brief Concrete backend operations for the host CPU.
 *
 * The struct simply forwards to lower-level detection helpers. Device manager templates can
 * substitute this type with mocks during testing to validate failure modes without relying
