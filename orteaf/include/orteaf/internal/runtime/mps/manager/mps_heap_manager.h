...
using HeapPayloadPool = ::orteaf::internal::runtime::base::pool::FixedSlotStore<
...
using HeapControlBlock = ::orteaf::internal::runtime::base::WeakControlBlock<
...
public:
  ...
  using HeapLease = ::orteaf::internal::runtime::base::WeakLease<
